<x-layouts.app>
    <div class="flex h-full w-full flex-1 flex-col gap-4 p-6">
        ...
        <div class="mb-4">
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Stay updated with your latest notifications and alerts.</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <div class="relative overflow-hidden rounded-xl border border-neutral-200 bg-white p-4 dark:border-neutral-700 dark:bg-zinc-800 transition-all duration-300 ease-in-out hover:shadow-lg hover:scale-105 hover:border-neutral-300 dark:hover:border-neutral-600 hover:bg-neutral-50 dark:hover:bg-zinc-700">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h3 class="font-semibold text-gray-700 dark:text-gray-200">New Assignment Posted</h3>
                        <p class="text-sm text-gray-600 dark:text-gray-400">CS101 - Programming Basics</p>
                    </div>
                </div>
                <p class="mt-4 text-sm text-gray-600 dark:text-gray-400">A new programming assignment has been posted for your review.</p>
                <div class="mt-4 space-y-3">
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600 dark:text-gray-400">Posted</span>
                        <span class="font-medium text-gray-700 dark:text-gray-200">1 hour ago</span>
                    </div>
                    <div class="flex justify-between text-sm">
                        <span class="text-gray-600 dark:text-gray-400">Priority</span>
                        <span class="font-medium text-amber-600 dark:text-amber-400">High</span>
                    </div>
                </div>
            </div>
        </div>
